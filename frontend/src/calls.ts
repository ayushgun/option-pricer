...
export function blackScholesCall(data: BlackScholes) {
  let call_url =
...
export function blackScholesPut(data: BlackScholes) {
  let call_url =
...
export function binomialCall(data: Binomial) {
  let call_url =
...
export function binomialPut(data: Binomial) {
  let call_url =
